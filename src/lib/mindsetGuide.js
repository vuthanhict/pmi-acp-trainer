...
export const MINDSET_DOMAINS = [
  ...
  { key: "manifesto", labelVi: "Giá trị & Nguyên tắc", labelEn: "Values & Principles" },
...
export const MINDSET_SECTIONS = [
  ...
  },
  {
    ...
    domain: "manifesto",
    type: "values",
    title: "4 giá trị của Tuyên ngôn Agile",
    intro: "PMI không tự đặt ra một bộ giá trị Agile riêng. Cả Agile Practice Guide lẫn ECO đều xây trên Tuyên ngôn Agile (2001) — nên đây MỚI là văn bản gốc, còn ECO là cách PMI diễn giải nó thành domain/task để ra đề. Cột tiếng Anh là nguyên văn để bạn đối chiếu với agilemanifesto.org; phần \"Trong đề thi\" là diễn giải theo khung ECO, không phải câu chữ của PMI.",
    preamble: {
      en: "We are uncovering better ways of developing software by doing it and helping others do it. Through this work we have come to value:",
      vi: "Chúng tôi đang tìm ra những cách tốt hơn để phát triển phần mềm bằng cách tự mình làm và giúp người khác làm. Qua công việc này, chúng tôi đi tới chỗ coi trọng:",
    },
    values: [
      {
        left: { en: "Individuals and interactions", vi: "Cá nhân và sự tương tác" },
        right: { en: "processes and tools", vi: "quy trình và công cụ" },
        pmi: "Nuôi Domain I (Mindset) và II (Leadership). Trong tình huống \"nhóm gặp vấn đề\", đáp án đúng gần như luôn là ĐỐI THOẠI trực tiếp với người liên quan, không phải thêm một quy trình, một công cụ theo dõi hay một biểu mẫu báo cáo.",
        trap: "Bẫy quen thuộc với người từ PMP: chọn phương án \"cập nhật kế hoạch quản lý giao tiếp\" hay \"đưa vào công cụ theo dõi\" — đúng ở PMP, sai ở ACP.",
      },
      {
        left: { en: "Working software", vi: "Phần mềm chạy được" },
        right: { en: "comprehensive documentation", vi: "tài liệu đầy đủ" },
        pmi: "Nuôi Domain III (Product) — đặc biệt task Quản lý increment và Đo lường giá trị đã bàn giao. Tiến độ đo bằng thứ CHẠY ĐƯỢC và đã được nghiệm thu, không đo bằng % công việc đã hoàn thành trên giấy.",
        trap: "\"Đầy đủ\" bị bỏ đi, không phải \"tài liệu\". Tài liệu vừa đủ để bàn giao và vận hành vẫn là bắt buộc — đáp án phủ nhận sạch tài liệu thường là đáp án sai.",
      },
      {
        left: { en: "Customer collaboration", vi: "Cộng tác với khách hàng" },
        right: { en: "contract negotiation", vi: "đàm phán hợp đồng" },
        pmi: "Nuôi task Đưa stakeholder vào từ ngày đầu (Mindset) và Tinh chỉnh Product Backlog cùng khách hàng (Product). Khi tình huống có bất đồng với khách hàng, chọn phương án KÉO HỌ VÀO cùng xem xét, không phải viện dẫn phạm vi đã ký.",
        trap: "Không có nghĩa là bỏ hợp đồng. Ở câu hỏi về hợp đồng, đáp án đúng thường là loại hợp đồng CHO PHÉP cộng tác (giá cố định theo increment, thời gian & vật tư có trần), chứ không phải \"bỏ qua điều khoản\".",
      },
      {
        left: { en: "Responding to change", vi: "Phản hồi với thay đổi" },
        right: { en: "following a plan", vi: "bám theo kế hoạch" },
        pmi: "Nuôi task Đón nhận thay đổi (Mindset) và Thích nghi quy trình khi độ ưu tiên đổi. Thay đổi đi vào Product Backlog và được ưu tiên lại — KHÔNG đi qua một hội đồng kiểm soát thay đổi.",
        trap: "\"Đưa yêu cầu ra Change Control Board\" là đáp án mồi kinh điển: đúng trong dự án dự đoán được, sai trong ngữ cảnh Agile.",
      },
    ],
    closing: {
      en: "That is, while there is value in the items on the right, we value the items on the left more.",
      vi: "Nghĩa là, dù các mục bên phải vẫn có giá trị, chúng tôi coi trọng các mục bên trái hơn.",
    },
    closingNote: "Vế sau mới là chỗ ra đề: bên phải KHÔNG bị vứt bỏ. Đáp án nào phủ nhận hoàn toàn quy trình, tài liệu, hợp đồng hay kế hoạch thì gần như chắc chắn sai.",
    source: "Manifesto for Agile Software Development — © 2001, the above authors. This declaration may be freely copied in any form, but only in its entirety through this notice. agilemanifesto.org",
  },
  {
    id: "agile-principles",
    domain: "manifesto",
    type: "principles",
    title: "12 nguyên tắc đứng sau Tuyên ngôn",
    intro: "Mỗi nguyên tắc kèm domain/task ECO mà nó nuôi, để bạn thấy đề thi đang kiểm tra nguyên tắc nào. Đối chiếu cột tiếng Anh với agilemanifesto.org/principles.html trước khi tin bản dịch.",
    principles: [
      { n: 1, en: "Our highest priority is to satisfy the customer through early and continuous delivery of valuable software.",
        vi: "Ưu tiên cao nhất của chúng tôi là làm hài lòng khách hàng thông qua việc bàn giao sớm và liên tục phần mềm có giá trị.",
        maps: "Product · Quản lý increment", pmi: "Chữ khóa là GIÁ TRỊ, không phải khối lượng. Khi phải chọn giữa \"làm xong nhiều việc\" và \"bàn giao được thứ khách dùng được sớm\", chọn vế sau." },
      { n: 2, en: "Welcome changing requirements, even late in development. Agile processes harness change for the customer's competitive advantage.",
        vi: "Chào đón yêu cầu thay đổi, kể cả khi đã ở giai đoạn muộn. Các quy trình Agile khai thác thay đổi để tạo lợi thế cạnh tranh cho khách hàng.",
        maps: "Mindset · Đón nhận thay đổi", pmi: "\"Kể cả khi đã muộn\" là phần bị bỏ quên nhiều nhất. Đáp án viện lý do \"đã chốt phạm vi\" hoặc \"để sang bản sau\" mà không hỏi giá trị là đáp án sai." },
      { n: 3, en: "Deliver working software frequently, from a couple of weeks to a couple of months, with a preference to the shorter timescale.",
        vi: "Bàn giao phần mềm chạy được một cách thường xuyên, từ vài tuần đến vài tháng, ưu tiên khoảng thời gian ngắn hơn.",
        maps: "Delivery · nhịp bàn giao", pmi: "Khi tình huống hỏi nên rút ngắn hay kéo dài chu kỳ, mặc định là RÚT NGẮN — chu kỳ ngắn cho phản hồi sớm hơn." },
      { n: 4, en: "Business people and developers must work together daily throughout the project.",
        vi: "Người làm nghiệp vụ và lập trình viên phải làm việc cùng nhau hằng ngày trong suốt dự án.",
        maps: "Leadership · Thúc đẩy tầm nhìn chung", pmi: "Là lý do vì sao đáp án \"để PM làm trung gian truyền đạt\" thường sai: Agile muốn hai bên nói chuyện TRỰC TIẾP, vai trò của bạn là gỡ rào cản cho việc đó." },
      { n: 5, en: "Build projects around motivated individuals. Give them the environment and support they need, and trust them to get the job done.",
        vi: "Xây dựng dự án xoay quanh những cá nhân có động lực. Hãy cho họ môi trường và sự hỗ trợ họ cần, và tin tưởng để họ hoàn thành công việc.",
        maps: "Leadership · Trao quyền cho nhóm", pmi: "Định nghĩa cô đọng nhất của servant leadership trong đề thi: cung cấp môi trường + hỗ trợ + TIN TƯỞNG. Đáp án nào tăng giám sát hay giao việc chi tiết đều đi ngược nguyên tắc này." },
      { n: 6, en: "The most efficient and effective method of conveying information to and within a development team is face-to-face conversation.",
        vi: "Cách truyền đạt thông tin hiệu quả và hiệu suất nhất tới và trong nội bộ nhóm phát triển là trò chuyện trực tiếp.",
        maps: "Mindset · Xây dựng minh bạch", pmi: "Với nhóm phân tán, \"trực tiếp\" được hiểu là video call — không phải email hay tài liệu. Đáp án chọn kênh giàu thông tin nhất có thể luôn thắng đáp án chọn kênh tiện nhất." },
      { n: 7, en: "Working software is the primary measure of progress.",
        vi: "Phần mềm chạy được là thước đo tiến độ chính yếu.",
        maps: "Product · Đo lường giá trị đã bàn giao", pmi: "Loại thẳng các đáp án đo tiến độ bằng số giờ đã bỏ ra, % tài liệu hoàn thành, hay số story đang làm dở." },
      { n: 8, en: "Agile processes promote sustainable development. The sponsors, developers, and users should be able to maintain a constant pace indefinitely.",
        vi: "Các quy trình Agile thúc đẩy phát triển bền vững. Nhà tài trợ, lập trình viên và người dùng cần có thể duy trì một nhịp độ ổn định vô thời hạn.",
        maps: "Delivery · nhịp bền vững", pmi: "Nền tảng của mọi câu hỏi về làm thêm giờ và nhồi phạm vi cuối sprint: đáp án đúng là giảm phạm vi, không phải tăng giờ làm." },
      ...
      { n: 11, en: "The best architectures, requirements, and designs emerge from self-organizing teams.",
        vi: "Kiến trúc, yêu cầu và thiết kế tốt nhất nảy sinh từ các nhóm tự tổ chức.",
        maps: "Mindset · nhóm cộng tác · Leadership · Trao quyền", pmi: "Trong câu hỏi \"ai quyết định cách làm\", câu trả lời là NHÓM — kể cả khi có kiến trúc sư hay PM trong phương án." },
      { n: 12, en: "At regular intervals, the team reflects on how to become more effective, then tunes and adjusts its behavior accordingly.",
