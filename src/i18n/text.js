...
export const UI_TEXT = {
  vi: {
    ...
    studyPhase_foundation: "Nền tảng", studyPhase_mock_exams: "Luyện đề thi thử", studyPhase_final_review: "Ôn nước rút", studyPhase_final_days: "Nghỉ & ôn nhẹ",
    studyPhaseHint_foundation: "Ưu tiên làm hết các đề required/recommended chưa từng làm (Practice mode) và luyện GAP các task critical.",
    studyPhaseHint_mock_exams: "Đã phủ nội dung — chuyển sang làm đề thi thử ĐẦY ĐỦ, tính giờ (Exam mode) để quen áp lực thời gian thật.",
    studyPhaseHint_final_review: "Chỉ còn ôn lại đúng các task còn yếu và từ vựng đã lưu — không học nội dung mới nữa.",
    ...
    studyDailyTarget: "Cần ~{n} câu/ngày để phủ hết nội dung còn lại trước ngày thi.",
    studyDailyTargetDone: "Đã phủ hết nội dung required/recommended — giữ nhịp ôn tập nhẹ tới ngày thi.",
    studyCurrentPace: "Nhịp hiện tại: {n} câu/ngày (trung bình 14 ngày gần nhất).",
    studyMilestonesHeader: "MỐC BẮT BUỘC",
    studyMilestone_core_coverage: "Đã làm {current}/{target} đề required + recommended",
    studyMilestone_no_critical_gap: "{current}/{target} task GAP không còn ở mức nghiêm trọng",
    studyMilestone_mock_exams: "Đã làm {current}/{target} bài thi thử đầy đủ (Exam mode)",
    studyMilestone_readiness: "Readiness Index đạt {target}+ trước {date} (hiện {current})",
    studyTimelineHeader: "LỊCH DỰ KIẾN",
    studySegment_foundation: "Nền tảng", studySegment_mock_exams: "Luyện đề thi thử", studySegment_final_review: "Ôn nước rút", studySegment_final_days: "Nghỉ & ôn nhẹ",
  ...
  en: {
    ...
    studyPhase_foundation: "Foundation", studyPhase_mock_exams: "Mock exams", studyPhase_final_review: "Final review", studyPhase_final_days: "Rest & light review",
    studyPhaseHint_foundation: "Prioritize finishing every required/recommended exam you haven't tried yet (Practice mode) and drilling critical GAP tasks.",
    studyPhaseHint_mock_exams: "Content covered — switch to FULL, timed mock exams (Exam mode) to get used to real time pressure.",
    studyPhaseHint_final_review: "Only review the tasks still weak and your saved vocab — no new content from here.",
    ...
    studyDailyTarget: "You need ~{n} questions/day to cover the remaining content before exam day.",
    studyDailyTargetDone: "Required/recommended content is fully covered — keep a light review pace until exam day.",
    studyCurrentPace: "Current pace: {n} questions/day (last-14-day average).",
    studyMilestonesHeader: "REQUIRED MILESTONES",
    studyMilestone_core_coverage: "Completed {current}/{target} required + recommended exams",
    studyMilestone_no_critical_gap: "{current}/{target} GAP tasks are no longer critical",
    studyMilestone_mock_exams: "Completed {current}/{target} full mock exams (Exam mode)",
    studyMilestone_readiness: "Readiness Index reaches {target}+ by {date} (currently {current})",
    studyTimelineHeader: "PROJECTED SCHEDULE",
    studySegment_foundation: "Foundation", studySegment_mock_exams: "Mock exams", studySegment_final_review: "Final review", studySegment_final_days: "Rest & light review",
