...
export const UI_TEXT = {
  vi: {
    ...
    // Results
    // Lượt làm đề (passStats.js)
    passLabel: "Lượt {n}",
    passCoverageDone: "{c}/{a} câu · xong {d}",
    passCoverageOngoing: "{c}/{a} câu · còn {n} câu của lượt này",
    ...
    planChartLabel: "Luỹ kế khối lượng lộ trình: thực tế so với kế hoạch",
    planAhead: "Vượt kế hoạch {n} câu (~{d} ngày)",
    planBehind: "Chậm kế hoạch {n} câu (~{d} ngày)",
    planMetDays: "đạt mục tiêu {m}/{n} ngày",
    planLegendActual: "Thực tế",
    planLegendPlan: "Kế hoạch",
    planDailyHeader: "MỤC TIÊU TỪNG NGÀY",
    planDailyLegend: "Vạch đứt = mục tiêu ngày hôm đó · xanh lá đạt · xanh dương vượt ≥125% · đỏ hụt · xám hôm nay chưa xong",
    planDayTip: "{date}: đi được {p}/{g} câu của lộ trình (đã trả lời {a} câu)",
    planDailyTarget: "Mục tiêu",
    planDailyDone: "Đi được",
    planPace: "Nhịp 7 ngày: {n} câu lộ trình/ngày",
    planNeeded: "Cần từ nay: {n} câu lộ trình/ngày",
    planRemaining: "Còn lại: {n} câu lộ trình",
    planProjected: "Giữ nhịp này xong ngày {d}",
    planProjectedNone: "Nhịp hiện tại bằng 0 — không có ngày về đích",
    planLateWarning: "Với nhịp hiện tại, khối lượng lộ trình sẽ xong SAU hạn học cuối ({d}). Hoặc tăng nhịp, hoặc bỏ bớt đề Tăng cường khỏi lộ trình.",
    planNoExamDate: "Đặt ngày thi để thấy tiến độ so với kế hoạch.",
    planOverdue: "Ngày thi đã qua — đặt lại ngày thi mới để lộ trình và biểu đồ tính lại từ đầu.",
    planScopeLine: "Đã hoàn thành {done}/{total} câu lộ trình · {from} → {to}",
    planToday: "hôm nay",
    planLegendProjected: "Giữ nhịp này",
    planShortfallAtExam: "Giữ nhịp hiện tại, tới ngày thi mới đi được {p}% khối lượng — còn thiếu {n} câu.",
    planMarker_foundation: "nền tảng",
    planMarker_gap_fill: "GAP",
    planMarker_mock_exams: "thi thử",
    planMarker_final_days: "nghỉ",
    planQuizHeader: "ĐỀ CÒN PHẢI LÀM XONG",
    planQuizDone: "xong {m}/{n} đề",
    ...
    reservedOnBtn: "Để dành đề này làm bài kiểm tra thật (luyện GAP sẽ không rút câu từ đây)",
    reservedOffBtn: "Bỏ để dành — cho phép luyện GAP rút câu từ đề này",
    resultsComparePass: "Lượt {a} → lượt {b}, trên {n} câu làm ở cả hai lượt: {pa}% → {pb}%",
    resultsComparePassDetail: "Sửa được {f} câu từng sai · {r} câu trước đúng nay sai",
    resultsComparePassNone: "Bạn đang ở lượt đầu của bộ đề này. So sánh tiến bộ sẽ xuất hiện khi bạn làm lại — và chỉ so trên đúng những câu xuất hiện ở cả hai lượt, vì so hai phiên khác nhau chỉ đo may rủi của việc bốc trúng câu nào.",

    trustedLabel: "Trusted score", rawLabel: "Raw score", independentLabel: "Independent score",
    rawFallbackBadge: "Điểm thô",
    rawFallbackNote: "Bộ đề này chưa được phân loại domain/task ECO nên không có điểm Trusted — số hiển thị là điểm thô.",
    ...
    readinessWhyBtn: "Vì sao lại là con số này?",
    readinessWhyTitle: "CON SỐ NÀY TÍNH THẾ NÀO",
    readinessFactorBase: "Mastery theo trọng số đề thi",
    readinessFactorBaseNote: "Σ(trọng số domain × mastery domain đó)",
    readinessFactorCoverage: "Độ phủ nội dung",
    readinessFactorCoverageNote: "{m}/{n} task đã có bằng chứng",
    readinessFactorRecency: "Độ mới của dữ liệu",
    readinessFactorRecencyNote: "{n} ngày không luyện",
    readinessFactorIndependence: "Làm không cần hỗ trợ",
    readinessFactorIndependenceNote: "{p}% câu có mở hỗ trợ tiếng Việt (tính theo trọng số độ mới)",
    readinessWhyFormula: "100 × {b} × {c} × {r} × {i} = {raw} → {score}",
    readinessWhyInsufficient: "Chưa chấm được: cần ít nhất {min} câu KHÁC NHAU đã làm, hiện mới có {n}. Làm lại cùng một câu nhiều lần không tính thêm.",
    ...
    reasonCritical: "{n} task ở mức critical — nặng nhất nằm ở domain {domain}",
    ...
    reasonVolume: "Mới có {n}/{min} câu khác nhau đã làm — chưa đủ để chấm mức sẵn sàng",
    ...
    todayAction_exam_mode: "Làm Exam mode: {quizName} (còn {examLeft} câu)",
    ...
    resultsCompareHeader: "TIẾN BỘ GIỮA CÁC LƯỢT",
  ...
  en: {
    ...
    passLabel: "Pass {n}",
    passCoverageDone: "{c}/{a} questions · finished {d}",
    passCoverageOngoing: "{c}/{a} questions · {n} left in this pass",
    ...
    planAhead: "Ahead of plan by {n} questions (~{d} days)",
    planBehind: "Behind plan by {n} questions (~{d} days)",
    planMetDays: "goal met {m}/{n} days",
    planLegendActual: "Actual",
    planLegendPlan: "Plan",
    planDailyHeader: "DAILY GOALS",
    planDailyLegend: "Dashed line = that day's goal · green met · blue exceeded ≥125% · red missed · grey today still open",
    planDayTip: "{date}: {p}/{g} plan questions covered ({a} answered)",
    planDailyTarget: "Goal",
    planDailyDone: "Covered",
    planPace: "7-day pace: {n} plan questions/day",
    planNeeded: "Needed from now: {n} plan questions/day",
    planRemaining: "Remaining: {n} plan questions",
    planProjected: "At this pace, done {d}",
    planProjectedNone: "Current pace is zero — no finish date",
    planLateWarning: "At the current pace the plan workload finishes AFTER the last study day ({d}). Either raise the pace or drop the optional quizzes from the plan.",
    planNoExamDate: "Set an exam date to see progress against the plan.",
    planOverdue: "The exam date has passed — set a new one to rebuild the plan and chart.",
    planScopeLine: "Completed {done}/{total} plan questions · {from} → {to}",
    planToday: "today",
    planLegendProjected: "At this pace",
    planShortfallAtExam: "At the current pace you reach only {p}% of the workload by exam day — {n} questions short.",
    planMarker_foundation: "foundation",
    planMarker_gap_fill: "gaps",
    planMarker_mock_exams: "mocks",
    planMarker_final_days: "rest",
    planQuizHeader: "QUIZZES STILL TO FINISH",
    planQuizDone: "{m}/{n} quizzes done",
    ...
    reservedOnBtn: "Reserve this quiz as a real mock exam (GAP practice won't draw from it)",
    reservedOffBtn: "Un-reserve — let GAP practice draw questions from this quiz",
    resultsComparePass: "Pass {a} → pass {b}, on {n} questions answered in both: {pa}% → {pb}%",
    resultsComparePassDetail: "Fixed {f} previously wrong · {r} were right before, wrong now",
    resultsComparePassNone: "You are still on the first pass of this quiz. Progress comparison appears once you redo it — and only on questions answered in both passes, since comparing two different sessions just measures which questions you happened to draw.",

    trustedLabel: "Trusted score", rawLabel: "Raw score", independentLabel: "Independent score",
    rawFallbackBadge: "Raw score",
    rawFallbackNote: "This quiz has no ECO domain/task classification yet, so there is no Trusted score — the number shown is the raw score.",
    ...
    readinessWhyBtn: "Why this number?",
    readinessWhyTitle: "HOW THIS NUMBER IS BUILT",
    readinessFactorBase: "Mastery weighted by exam blueprint",
    readinessFactorBaseNote: "Σ(domain weight × that domain's mastery)",
    readinessFactorCoverage: "Content coverage",
    readinessFactorCoverageNote: "{m}/{n} tasks have evidence",
    readinessFactorRecency: "Data freshness",
    readinessFactorRecencyNote: "{n} day(s) since last practice",
    readinessFactorIndependence: "Working without support",
    readinessFactorIndependenceNote: "{p}% of answers opened Vietnamese support (recency-weighted)",
    readinessWhyFormula: "100 × {b} × {c} × {r} × {i} = {raw} → {score}",
    readinessWhyInsufficient: "Not scored yet: needs at least {min} DISTINCT questions answered, currently {n}. Re-answering the same question does not add to this.",
    ...
    reasonCritical: "{n} task(s) at critical level — the most critical one is in {domain}",
    ...
    reasonVolume: "Only {n}/{min} distinct questions answered — not enough to score readiness yet",
    ...
    todayAction_exam_mode: "Exam mode: {quizName} ({examLeft} left)",
    ...
    resultsCompareHeader: "PROGRESS BETWEEN PASSES",
